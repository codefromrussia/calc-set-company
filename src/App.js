		...
		if ( l > 0 && //Пункт 1.1.1
			...
			this.result(550, 550);
						...
						this.result(550, 550);
								...
								(( x1 && x2 <= 15 && type === "old" ) || 
								( x3 > 0 && x3 <= 15 && type === "new" )) ) { 
			this.result(554.42*x3*1.2, 16035.88*1.2);
			...
			this.result(554.42*x3*1.2, 16035.88*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) {  
			let resultMaxPower = +airMaxPower === 0 ? 0: ((554.42*x3)+(airMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (air*lBuilding))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) {  
			let resultMaxPower = +cabelMaxPower === 0 ? 0: ((554.42*x3)+(cabelMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (cabel*lBuilding))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 ? 0: ((554.42*x3)+(airMaxPower*x3)*2)*1.2;
			this.result(resultMaxPower, (16035.88 + (air*lBuilding)*2)*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +cabelMaxPower === 0 ? 0: ((554.42*x3)+(cabelMaxPower*x3)*2)*1.2;
			this.result(resultMaxPower, (16035.88 + (cabel*lBuilding)*2)*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +cabelMaxPower === 0 ? 0: ((554.42*x3)+((Number(airMaxPower)+Number(cabelMaxPower))*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((Number(air)+Number(cabel))*lBuilding))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +tpMaxPower === 0 ? 0: ((554.42*x3)+(airMaxPower*x3)+(tpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (air*lBuilding)+(tp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) {  
			let resultMaxPower = +airMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+(airMaxPower*x3)+(rtpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (air*lBuilding)+(rtp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) {  
			let resultMaxPower = +cabelMaxPower === 0 || +tpMaxPower === 0 ? 0: ((554.42*x3)+(cabelMaxPower*x3)+(tpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (cabel*lBuilding)+(tp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +cabelMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+(cabelMaxPower*x3)+(rtpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + (cabel*lBuilding)+(rtp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +tpMaxPower === 0 ? 0: ((554.42*x3)+((airMaxPower*x3)*2)+(tpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((air*lBuilding)*2)+(tp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +cabelMaxPower === 0 || +tpMaxPower === 0 ? 0: ((554.42*x3)+((cabelMaxPower*x3)*2)+(tpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((cabel*lBuilding)*2)+(tp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((airMaxPower*x3)*2)+(rtpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((air*lBuilding)*2)+(rtp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +cabelMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((cabelMaxPower*x3)*2)+(rtpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((cabel*lBuilding)*2)+(rtp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +cabelMaxPower === 0 || +tpMaxPower === 0 ? 0: ((554.42*x3)+((Number(airMaxPower) + Number(cabelMaxPower))*x3)+(tpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((Number(air) + Number(cabel))*lBuilding)+(tp*x3))*1.2);
		} else if ( building === "yes" && //Город. 2-я кат. над. Воздушная и Кабельная ЛЭП. ТП
								category === "2" &&
								powerLine === "aircabel" &&
								tpRtp === "rtp" &&
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +cabelMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((Number(airMaxPower) + Number(cabelMaxPower))*x3)+(rtpMaxPower*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((Number(air) + Number(cabel))*lBuilding)+(rtp*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +airMaxPower === 0 || +tpMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((airMaxPower*x3)*2)+((Number(tpMaxPower) + Number(rtpMaxPower))*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((air*lBuilding)*2)+((Number(tp) + Number(rtp))*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) { 
			let resultMaxPower = +cabelMaxPower === 0 || +tpMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((cabelMaxPower*x3)*2)+((Number(tpMaxPower) + Number(rtpMaxPower))*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((cabel*lBuilding)*2)+((Number(tp) + Number(rtp))*x3))*1.2);
								...
								(( x1 && x2 >= 151 && x2 <= 8900 && type === "old" ) || 
								( x3 >= 151 && x3 <= 8900 && type === "new" )) ) {
			let resultMaxPower = +airMaxPower === 0 || +cabelMaxPower === 0 || +tpMaxPower === 0 || +rtpMaxPower === 0 ? 0: ((554.42*x3)+((Number(airMaxPower) + Number(cabelMaxPower))*x3)+((Number(tpMaxPower) + Number(rtpMaxPower))*x3))*1.2;
			this.result(resultMaxPower, (16035.88 + ((Number(air) + Number(cabel))*lBuilding)+((Number(tp) + Number(rtp))*x3)*1.2));
		} else {
			this.result(0, 0);
		}
	}
